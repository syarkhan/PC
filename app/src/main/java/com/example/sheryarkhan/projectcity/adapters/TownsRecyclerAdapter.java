...
public class TownsRecyclerAdapter extends RecyclerView.Adapter<TownsRecyclerAdapter.MainViewHolder> implements Filterable {
    ...
    ArrayList<Constants.Areas> TOWN;
...
//                            }
    ...
    private ArrayList<String> getAutocomplete(CharSequence charSequence) {
...
//    public static TownsRecyclerAdapter getItem(int position) {
